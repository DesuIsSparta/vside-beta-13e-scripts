...
function initGenres() {
    %i = 0;
    %i["h" @ $Genres TAB %i = (%i + 1.0) @ 0] = ;
    %i["confident" @ $Genres TAB %i @ 1] = ;
    %i["i" @ $Genres TAB %i = (%i + 1.0) @ 0] = ;
    %i["relaxed" @ $Genres TAB %i @ 1] = ;
    %i["p" @ $Genres TAB %i = (%i + 1.0) @ 0] = ;
    %i["upbeat" @ $Genres TAB %i @ 1] = ;
    %i["b" @ $Genres TAB %i = (%i + 1.0) @ 0] = ;
    %i["blue" @ $Genres TAB %i @ 1] = ;
    %i["z" @ $Genres TAB %i = (%i + 1.0) @ 0] = ;
    %i["zombie" @ $Genres TAB %i @ 1] = ;
    $GenresCount = %i;
};
function initTeleports() {
    %i = 0;
    %i['TeleportToPlayer' @ $teleportsNV TAB %i = (%i + 1.0) @ 0] = ;
    %i["nobunaga" @ $teleportsNV TAB %i @ 1] = ;
    %i['TeleportToTransform' @ $teleportsNV TAB %i = (%i + 1.0) @ 0] = ;
    ...
    %i['TeleportToSpawnGroup' @ $teleportsNV TAB %i = (%i + 1.0) @ 0] = ;
    ...
    $teleportsNVCount = %i;
    %i = 0;
    %i['TeleportToPlayer' @ $teleportsLGA TAB %i = (%i + 1.0) @ 0] = ;
    ...
    %i['TeleportToTransform' @ $teleportsLGA TAB %i = (%i + 1.0) @ 0] = ;
    ...
    %i['TeleportToSpawnGroup' @ $teleportsLGA TAB %i = (%i + 1.0) @ 0] = ;
    ...
    $teleportsLGACount = %i;
    %i = 0;
    %i['TeleportToTransform' @ $teleportsRJ TAB %i = (%i + 1.0) @ 0] = ;
