...
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 30007;
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 30013;
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 30014;
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 30002;
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 27002;
$specialSKUs["noBackendVet"][$specialSKUs @ "noBackendVet"] = $specialSKUs["noBackendVet"] @ " " @ 17002;
