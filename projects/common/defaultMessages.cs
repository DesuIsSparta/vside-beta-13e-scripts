function setupDefaultMessages() {
    ...
    $MsgCat::applauseGui["BODYTEXT-BLOCKGAME-BLOCKGAMETHEGRIND"] = "            I/Up: Rotate CW" @ "\n" @ "J: Left      K: Rotate CCW    L: Right" @ "\n" @ "Space: Drop" @ "\n" @ "Down: Fast Fall";
    ...
    $MsgCat::applauseGui["BODYTEXT-SUMO"] = "Q: Jab   W: Power Strike   E: Sumo Stomp" @ "\n" @ "A: Jab Block   S: Power Block" @ "\n" @ "Z: Taunt1   X: Taunt2  SPACEBAR: Jump";
    ...
    $MsgCat::applauseGui["BODYTEXT-PILLOW"] = "Q: Jab   W: Power Strike   E: Super Spin" @ "\n" @ "A: Jab Block   S: Power Block" @ "\n" @ "Z: Taunt1   X: Taunt2  SPACEBAR: Jump";
    ...
    $MsgCat::closet["MSG-USE-PROP-BODY"] = "You have an object in your hand." @ "\n" @ "Hold down (CTRL + ENTER) to use it." @ "\n" @ "(CTRL + ') and (CTRL + ;) for additional actions.";
    ...
    $MsgCat::custSpace["MEDIA_HELP"] = "<just:left>" @ "\n" @ "Use the <spush><b>My Music & Videos<spop> panel to customize what's playing in your space!" @ "\n" @ "" @ "\n" @ "There are three different types of music & video to choose from:" @ "\n" @ "" @ "\n" @ "* Choose from nearly twenty vSide radio stations - just use the \"vSide Radio\" pull-down" @ "\n" @ "" @ "\n" @ "* Any YouTube video or playlist - just copy the item URL from YouTube into one of the \"Media URL\" slots" @ "\n" @ "     <a:http://youtube.com>Click Here</a> to browse YouTube." @ "\n" @ "" @ "\n" @ "* Any SHOUTcast Station - just copy the item URL from classic SHOUTcast into one of the \"Media URL\" slots" @ "\n" @ "     <a:http://classic.shoutcast.com>Click Here</a> to browse classic SHOUTcast." @ "\n" @ "" @ "\n" @ "For more detailed info, <a:http://www.vside.com/go/apartments>click here</a>. For info on DJing and broadcasting your own stream, <a:http://www.vside.com/go/dj>click here</a>.";
    ...
    $MsgCat::custSpacSel["RETURN-TO-LOBBY-TEXT"] = "Would you like to return to the lobby? This will require transitioning to a new server.";
    ...
    $MsgCat::destinations["REMOTE-BODY"] = "" @ "\n" @ "are you sure you want to go?";
    ...
    $MsgCat::UI["TOOMANYFRIENDS"] = "Whoa! You've got a lot of friends! So many friends, actually, that it might be slowing vSide down." @ "\n" @ "For technical reasons, an upcoming release is going to limit the size of your Friends List - but don't worry, you won't lose your best buds and you'll still be able to make new friends." @ "\n" @ "Read all about it <linkcolor:e553ff><linkcolorhl:ff93f8><a:http://forums.vside.com/forums/ann.jspa?annID=332>here</a>.";
